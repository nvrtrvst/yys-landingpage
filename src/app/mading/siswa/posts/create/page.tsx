...
export default function CreatePostPage() {
  ...
  useEffect(() => {
    ...
    fetch("/api/mading/categories").then((r) => r.json()).then((d) => setCategories(d.data || d || [])).catch(() => {});
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-1">Tulisan Baru</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-xl p-6 space-y-5">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">HTML dasar didukung: &lt;p&gt;, &lt;br&gt;, &lt;b&gt;, &lt;i&gt;, &lt;u&gt;.</p>
        </div>
